...
const FidelityVideoSection = () => {
    ...
    return (
        ...
        >
            {/* Text Section*/}
            <Box
                p={['20px 20px 20px 30px', '40px 40px 40px 50px', '50px calc(50px)', '50px calc(60px)', '50px calc(75px )']}
                w={['auto', '50%']}
            ...
            >
                ...
                <Box>
                    <Reveal keyframes={customAnimation} direction={'down'} cascade triggerOnce>
                        ...
                        >
                            ...
                            Keep sending photos, files, links, ask questions, or have a side conversation, without
                ...
                <Reveal keyframes={customAnimation} direction={'down'} cascade triggerOnce>
                    ...
                    <Box
                        ...
                        mt={'15px'}
                    >
                        Quill makes it easy to view any video call, channel, or conversation side-by-side — just open a
                        split view.
                    </Box>
                </Reveal>
            </Box>
